...
contract Recovery is Roles2LibraryAdapter {
    ...
    function Recovery(address _roles2Library) public Roles2LibraryAdapter(_roles2Library) {}

    function recoverUser(User _userContract, address _newAddress) external auth() returns(bool) {
