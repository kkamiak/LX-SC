...
contract Storage is Owned {
    ...
    function setManager(Manager _manager) public onlyContractOwner() returns(bool) {
        manager = _manager;
        return true;
    }
    ...
    function getUInt(bytes32 _crate, bytes32 _key) public constant returns(uint) {
    ...
    function getInt(bytes32 _crate, bytes32 _key) public constant returns(int) {
    ...
    function getUInt8(bytes32 _crate, bytes32 _key) public constant returns(uint8) {
    ...
    function getBytes32(bytes32 _crate, bytes32 _key) public constant returns(bytes32) {
    ...
    function getAddressUInt8(bytes32 _crate, bytes32 _key) public constant returns(address, uint8) {
